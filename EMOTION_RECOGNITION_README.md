...
## Overview
Audio Input → Groq STT → Voice Emotion Analysis + Text Emotion Analysis → Console Output
...
Models
Voice Emotion: wav2vec2-base-superb-er

Text Emotion: emotion-english-distilroberta-base

Speech-to-Text: Groq Whisper Turbo API
